...
#define RADIOLIB_LORAWAN_APP_KEY   0x9D, 0xAB, 0xD0, 0xC7, 0xE0, 0x82, 0xF2, 0x9A, 0xCD, 0xC7, 0x13, 0x8F, 0x17, 0xF8, 0x47, 0x64
#endif
#ifndef RADIOLIB_LORAWAN_NWK_KEY   // Put your Nwk Key here | LoRaWAN v=1.0.x dont use this
